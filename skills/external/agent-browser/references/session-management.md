...
agent-browser --session s1 screenshot ~/model-set/skills/agent-browser/screenshots/page1.png
agent-browser --session s2 screenshot ~/model-set/skills/agent-browser/screenshots/page2.png
```
